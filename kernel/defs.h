...
int  uvmcopy(pagetable_t, pagetable_t, uint64, uint64); // HOMEWORK 5, mmap and munmap
int  uvmcopyshared(pagetable_t, pagetable_t, uint64, uint64); // HOMEWORK 5, mmap and munmap
